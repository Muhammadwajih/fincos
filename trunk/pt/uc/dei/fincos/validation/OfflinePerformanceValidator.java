...
public class OfflinePerformanceValidator {	
	...
	private TreeSet<PerformanceStats> statsOverTime; // Stores query stats over time
	 ...
	 * @throws Exception 
	 */
	public OfflinePerformanceValidator(String inputLogFilesPaths[], boolean saveToFile, String outputLogFilePath) throws Exception {								
	 ...
	 * 
	 * @param startTime		Staring point from which log files must be processed(in milliseconds)
	...
	class LogProcessor extends Thread{
		CSVReader logReader;
		HashMap<String, PerformanceStats> streamsStats; // Keeps a snapshot of the stats
